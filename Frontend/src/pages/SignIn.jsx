    ...
    return(
        ...
        <div className='w-full h-screen bg-cover flex justify-center items-center' style={{backgroundImage:`url(${bg})`}}>
         <form className='w-[90%] h-[600px] max-w-[500px] bg-[#00000062] backdrop-blur shadow-lg shadow-black flex flex-col items-center justify-center gap-5 px-5' onSubmit={handleSignIn}>
            <h1 className='text-white text-[30px] font-semibold mb-[30px]'>Sign In <span className='text-blue-400'>Virtual Assistant</span></h1>
            ...
            onClick={()=>navigate("/signup")}>Don't have an account?<span className="text-blue-400">Sign Up</span></p>
         </form>
